...
public class UpdateInfoModel
{
    ...
    /// </summary>
    [XmlElement("Launcher")]
    public Item LauncherInfo { get; set; } = new();

    /// <summary>
    /// 资源更新信息。
    /// </summary>
    [XmlElement("Resource")]
    public Item ResourceInfo { get; set; } = new();

    /// <summary>
    /// 脚本更新信息。
    /// </summary>
    [XmlElement("Script")]
    public Item ScriptInfo { get; set; } = new();
    ...
    public class Item
    {
        ...
        /// </summary>
        [XmlElement("Hash")]
        public Checksum FileHash { get; set; } = new();

        /// <summary>
        /// 更新包的校验值。
        /// </summary>
        [XmlElement("Checksum")]
        public Checksum PackageHash { get; set; } = new();
