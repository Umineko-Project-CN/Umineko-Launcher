...
public class AnimatedControl : UserControl
{
    ...
    protected readonly BlurEffect _blurEffect = new() { Radius = 20 };

    protected readonly DoubleAnimation _blurFadeIn = new()
    {
        From = 20,
        To = 0,
    ...
    protected readonly DoubleAnimation _blurFadeOut = new()
    {
        From = 0,
        To = 20,
        Duration = TimeSpan.FromSeconds(0.2),
    ...
    protected readonly DoubleAnimation _opacityFadeIn = new()
    {
        From = 0,
        To = 1,
        Duration = TimeSpan.FromSeconds(0.2),
    ...
    protected readonly DoubleAnimation _opacityFadeOut = new()
    {
        From = 1,
        To = 0,
        Duration = TimeSpan.FromSeconds(0.2),
    ...
    private readonly Storyboard _fadeInAnimation = new();
    private readonly Storyboard _fadeOutAnimation = new();
    private readonly ObjectAnimationUsingKeyFrames _visibilityFadeIn = new();
    private readonly ObjectAnimationUsingKeyFrames _visibilityFadeOut = new();
    ...
    public AnimatedControl()
    {
        ...
        _visibilityFadeIn.KeyFrames.Add(
            new DiscreteObjectKeyFrame(Visibility.Visible, TimeSpan.FromSeconds(0.0))
        );
        _visibilityFadeOut.KeyFrames.Add(
            new DiscreteObjectKeyFrame(Visibility.Visible, TimeSpan.FromSeconds(0.0))
        );
        _visibilityFadeOut.KeyFrames.Add(
            new DiscreteObjectKeyFrame(Visibility.Collapsed, TimeSpan.FromSeconds(0.2))
        );
