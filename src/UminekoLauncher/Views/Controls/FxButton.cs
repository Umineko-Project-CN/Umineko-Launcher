...
internal class FxButton : Button
{
    ...
    public static readonly DependencyProperty FontMarginProperty = DependencyProperty.Register(
        nameof(FontMargin),
        typeof(Thickness),
        typeof(FxButton),
        new PropertyMetadata()
    ...
    static FxButton()
    {
        DefaultStyleKeyProperty.OverrideMetadata(
            typeof(FxButton),
            new FrameworkPropertyMetadata(typeof(FxButton))
        );
    }
